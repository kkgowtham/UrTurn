...
public class ProfileActivity extends AppCompatActivity {
        ...
        try {
           ...
           databaseReference.addValueEventListener(new ValueEventListener() {
               ...
               public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    mPicUrl=userModel.getPicUrl();
                    memail=userModel.getEmail();
                    mUserName=h;
                   Picasso.get().load(userModel.getPicUrl()).placeholder(R.drawable.ic_account_circle_black_24dp).into(imageView);
    ...
    private void parseJson() {
        ...
        try {
            ...
            try {
                ...
                final StateAdapter stateAdapter = new StateAdapter(ProfileActivity.this,
    ...
    public void updateProfile(View view) {
        ...
        EditText phoneEditText=findViewById(R.id.phone_noedittext);
